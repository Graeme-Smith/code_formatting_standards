...
class thing:
    ...
    def __repr__(self):
        return f"Thing(name={self.name!r}, items={self.items!r})"
...
def typing_examples() -> None:
    ...
    optional_val: int | None = "nope"
    thing_or_int: int | thing = SimpleGreeter()  # weird union use
...
def main():
    ...
    squared = [i * i for i in messy_list if i % 2 == 0]
